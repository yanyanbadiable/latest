...
if($_POST) {	
	...
	$sql = "UPDATE orders SET order_date = '$orderDate', sub_total = '$subTotalValue', total_amount = '$totalAmountValue', discount = '$discount', grand_total = '$grandTotalValue', paid = '$paid', due = '$dueValue', order_status = 1 WHERE order_id = {$orderId}";	
	$connect->query($sql);

	...
	if(divRequest == 'add')  {
		...
		$("#createOrderForm").unbind('submit').bind('submit', function() {
		    ...
		    if(productName[x].value == ''){	    		    	
		    	$("#"+productNameId+"").after('<p class="text-danger">   Field is required!! </p>');
		...
		$("#editOrderForm").unbind('submit').bind('submit', function() {
	   	...
	   	for (var x = 0; x < quantity.length; x++) {       
	 			var quantityId = quantity[x].id;
		    if(quantity[x].value == ''){	    	
		    	$("#"+quantityId+"").after('<p class="text-danger"> Field is required!! </p>');
		    	$("#"+quantityId+"").closest('.form-group').addClass('has-error');	    		    		    	
	      } else {      	
		    	$("#"+quantityId+"").closest('.form-group').addClass('has-success');	    		    		    		    	
	      } 
...
function getTotal(row = null) {
	if (row) {
		var rate = parseFloat($("#rate" + row).val()) || 0;
...
function subAmount() {
	...
	$("#productTable tbody tr").each(function () {
		...
		totalSubAmount += parseFloat($("#total" + count).val()) || 0;
	});
	...
	// Total Amount
	var totalAmount = parseFloat($("#subTotal").val()) || 0;
	totalAmount = totalAmount.toFixed(2);
	$("#totalAmount").val(totalAmount);
	$("#totalAmountValue").val(totalAmount);

	var discount = parseFloat($("#discount").val()) || 0;
	var grandTotal = (totalAmount - discount).toFixed(2);
	...
	var dueAmount = (grandTotal - paidAmount).toFixed(2);
	...
	if(orderId) {
		...
		$.ajax({
			...
			success:function(response) {				
				...
				var paidAmount = response.order[6] 
				var dueAmount = response.order[7];							
				var grandTotal = response.order[5];
